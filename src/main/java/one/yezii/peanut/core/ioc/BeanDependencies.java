...
public class BeanDependencies {
    ...
    public BeanDependencies(String basePackage) {
        ...
        this.beanMap = scanResult
                ...
                .collect(Collectors.toMap(ClassInfo::getName, this::getBeanContainerOfClassInfo));
    }
    ...
    private List<String> getDependenciesOfClassInfo(ClassInfo classInfo) {
    ...
    private BeanContainer getBeanContainerOfClassInfo(ClassInfo classInfo) {
        return BeanContainer.ofName(classInfo.getName())
                .addDependencies(getDependenciesOfClassInfo(classInfo))
                .setBeanClass(classInfo.loadClass())
                .addInterfaces(classInfo.getInterfaces().getNames())
